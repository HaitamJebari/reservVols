...
import HomeSign from './Components/Container/HomeSign'
  ...
  return (
    ...
    <Navbar/>
     <Routes>
        ...
        <Route path="/HomeSign" element={<HomeCon><HomeSign/></HomeCon>} ></Route>
        <Route path="/:name" element={<HomeCon><Home/></HomeCon>} ></Route>
